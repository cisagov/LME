...
def test_elastic_agent_logs_search(es_host, es_port, username, password):
    ...
    for x in range(len(data[rootKey]["hits"])):
        ...
        #assert data[rootKey]["hits"][x]["_source"]["agent"]["version"]=="9.0.2"
        ...
        #assert data[rootKey]["hits"][x]["_source"]["elastic_agent"]["version"]=="9.0.2"
